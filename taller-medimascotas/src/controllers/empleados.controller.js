...
const getAll = async (req, res) => {
  try {
    ...
    const data = await EmpleadoModel.getAll();
...
const getById = async (req, res) => {
  try {
    ...
    const item = await EmpleadoModel.getById(id);
...
const create = async (req, res) => {
  try {
    ...
    const data = await EmpleadoModel.create(req.body);
...
const update = async (req, res) => {
  try {
    ...
    const itemActualizado = await EmpleadoModel.update(id, req.body);
