...
const veterinariaModel = require('../models/veterinaria.model');
...
const getAll = async (req, res) => {
  try {
    ...
    const data = await veterinariaModel.getAll();
...
// Controlador para obtener un empleado específico mediante su ID
const getById = async (req, res) => {
  try {
    ...
    const item = await veterinariaModel.getById(id);
...
const create = async (req, res) => {
  try {
    ...
    const data = await veterinariaModel.create(req.body);
...
// Controlador para actualizar un empleado existente por su ID
const update = async (req, res) => {
  try {
    ...
    const itemActualizado = await veterinariaModel.update(id, req.body);
...
const remove = async (req, res) => {
  try {
    ...
    const eliminado = await veterinariaModel.remove(id);
