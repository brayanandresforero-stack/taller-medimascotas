...
const getAll = async (req, res) => {
  try {
    ...
    const data = await inventarioModel.getAll();
...
// Controlador para obtener un inventario específico mediante su ID
const getById = async (req, res) => {
  try {
    ...
    const item = await inventarioModel.getById(id);
...
const create = async (req, res) => {
  try {
    ...
    const data = await inventarioModel.create(req.body);
...
// Controlador para actualizar un inventario existente por su ID
const update = async (req, res) => {
  try {
    ...
    const itemActualizado = await inventarioModel.update(id, req.body);
...
const remove = async (req, res) => {
  try {
    ...
    const eliminado = await inventarioModel.remove(id);
