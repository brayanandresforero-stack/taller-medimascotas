// Importación del modelo que maneja las consultas SQL para mascota (cambiar el nombre de nuevo modelo)
const mascotaModel = require('../models/mascota.model');

// Controlador para obtener todos los mascota
...
const getById = async (req, res) => {
  try {
    ...
    const item = await mascotaModel.getById(id);
...
const update = async (req, res) => {
  try {
    ...
    const itemActualizado = await mascotaModel.update(id, req.body);
...
const remove = async (req, res) => {
  try {
    ...
    const eliminado = await mascotaModel.remove(id);
